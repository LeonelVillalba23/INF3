...
- Monticulo: inserciones y extracción básica.
...
- PercolateUp: percolateUp paso a paso.
...
- PercolateDownn: percolateDown paso a paso.
...
- Heap: visualización del heap como árbol.
...
- Heapify: heapify desde un arreglo.
...
- Heapshort: heapsort con el heap.
...
- MaxxHeap: uso de MaxHeap (orden descendente).
...
- PrioridadPacientes: cola de prioridad aplicada a pacientes.
...
- EstadoInterno: traza del estado interno del heap.
...
- AgendaDeTareas: interfaz interactiva de AgendaTareas.
